...
package com.minecraft.stew.core.command.argument.eval;

import com.minecraft.stew.core.command.annotation.IgnoreQuote;
import com.minecraft.stew.core.command.annotation.Optional;
import com.minecraft.stew.core.command.function.Context;
import com.minecraft.stew.core.command.exception.CommandException;
import com.minecraft.stew.core.command.exception.NoSuchConverterException;
import com.minecraft.stew.core.command.util.ArrayUtil;
import lombok.RequiredArgsConstructor;
import com.minecraft.stew.core.command.argument.AdapterMap;
import com.minecraft.stew.core.command.argument.Argument;
...
public class MethodEvaluator {
    ...
    @SuppressWarnings("unchecked")
    private Argument createOptional(Method method, Class type, boolean isArray, String[] def, Argument.ArgumentBuilder builder) {
