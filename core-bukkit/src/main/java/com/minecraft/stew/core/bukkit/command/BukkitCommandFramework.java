...
package com.minecraft.stew.core.bukkit.command;
...
import com.minecraft.stew.core.bukkit.command.executor.BukkitCompleterExecutor;
import com.minecraft.stew.core.bukkit.command.function.BukkitCommand;
 ...
 */
@Getter
public final class BukkitCommandFramework implements CommandFramework<Plugin, CommandSender, BukkitCommand> {
     ...
     */
    public BukkitCommandFramework(@NonNull @NotNull Plugin plugin, @NonNull @NotNull AdapterMap adapterMap) {
        this.plugin = plugin;
     ...
     */
    public BukkitCommandFramework(@NonNull @NotNull Plugin plugin, boolean registerDefault) {
        this(plugin, new AdapterMap(registerDefault));

        if (registerDefault) {
            registerAdapter(PrefixType.class, PrefixType::findByName);
