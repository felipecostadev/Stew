...
import com.minecraft.stew.core.bukkit.command.executor.BukkitCommandExecutor;
...
public class BukkitCommand extends Command implements CommandHolder<CommandSender, BukkitChildCommand> {
    ...
    private final BukkitCommandFramework frame;
     ...
     */
    public BukkitCommand(@NonNull @NotNull BukkitCommandFramework frame, @NonNull @NotNull String name, int position) {
        super(name);
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String commandLabel, @NotNull String[] args) {
        ...
        if (commandInfo != null && !BukkitPlatformValidator.INSTANCE.validate(commandInfo.getPlatform(), sender)) {
            sender.sendMessage(frame.getMessageHolder().getReplacing(MessageType.INCORRECT_TARGET, commandInfo.getPlatform().name()));
            return false;
        }
        ...
        final BukkitContext context = new BukkitContext(commandLabel, sender, BukkitPlatformValidator.INSTANCE.fromSender(sender), null, args, frame, this);
    ...
    public @NotNull List<String> tabComplete(@NotNull CommandSender sender, @NotNull String alias,
        ...
        if (completerExecutor != null) {
            return completerExecutor.execute(new BukkitContext(alias, sender, BukkitPlatformValidator.INSTANCE.fromSender(sender), null, args, frame, this));
        }
